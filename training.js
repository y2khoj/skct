(function () {
  ...
  function buildUI() {
    ...
    home.innerHTML = `
      <nav class="home-nav"><div class="home-brand"><span class="logo-badge">SKCT</span> 나의 훈련실</div><div class="home-mode-links"><span class="muted" id="storage-status">이 브라우저에 자동 저장</span><button type="button" id="home-fullscreen-btn" class="fullscreen-toggle-btn action" style="background:rgba(30,41,59,0.7); color:#38bdf8; border:1px solid rgba(56,189,248,0.35); padding:8px 14px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px; cursor:pointer;" title="태블릿/PC 전체화면 몰입 모드 (F11)"><span class="fullscreen-icon">⛶</span> <span class="fullscreen-text">전체화면</span></button><a href="calc-drill.html" class="action" style="background:#0f766e; color:#5eead4; border-color:#14b8a6; text-decoration:none; padding:8px 14px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px;">⚡ 스피드 계산 연습관 →</a><a href="exam.html" class="action primary-link" style="background:#2563eb; color:#ffffff; border-color:#3b82f6; text-decoration:none; padding:8px 14px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px;">📝 기존 모의고사 바로가기 →</a></div></nav>
      ...
      <div class="mode-grid" role="group" aria-label="훈련 단계">
       ...
       <a href="calc-drill.html" class="mode-card mode-card-calc" style="border-color:#14b8a6; background:rgba(20,184,166,0.08);"><small style="color:#2dd4bf;">자료해석 속산 특훈 · 비타민</small><b style="color:#5eead4;">⚡ 스피드 계산 연습</b><span style="color:#ccfbf1;">분수 비교 · 증가율 · 비중 · 곱셈<br>타임어택 어림셈 무한 드릴 →</span></a>
